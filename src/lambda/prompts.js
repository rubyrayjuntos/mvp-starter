...
exports.ISSUE_EXTRACTION_PROMPT = `Extract all issues and defects from the following property inspection report text. 
...
OCR TEXT:
{{OCR_TEXT}}`;
exports.NEGOTIATION_PLAN_PROMPT = `You are an expert real estate negotiation assistant. 
