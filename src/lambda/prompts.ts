export const ISSUE_EXTRACTION_PROMPT = `You are an expert at analyzing residential property inspection reports. Extract ALL issues, defects, and concerns from the following inspection report text.
...
export const NEGOTIATION_PLAN_PROMPT = `You are an expert real estate negotiation consultant helping a buyer's agent. Based on the inspection issues below, create a strategic negotiation plan.
