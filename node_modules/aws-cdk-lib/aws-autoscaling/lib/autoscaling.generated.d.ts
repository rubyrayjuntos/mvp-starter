...
import { aws_autoscaling as autoScalingRefs, aws_ec2 as ec2Refs, aws_elasticloadbalancing as elasticLoadBalancingRefs, aws_elasticloadbalancingv2 as elasticLoadBalancingV2Refs, aws_iam as iamRefs, aws_sns as snsRefs, aws_sqs as sqsRefs } from "../../interfaces";
...
export interface CfnAutoScalingGroupProps {
     ...
     */
    readonly loadBalancerNames?: Array<elasticLoadBalancingRefs.ILoadBalancerRef | string>;
    /**
     * The maximum amount of time, in seconds, that an instance can be in service.
     *
